            ...
            [
                [
                    InlineKeyboardButton(
                        "• نـصـب بـوتك مـن هـنا •", url="https://t.me/ZEYADZAGLOL",
                    )
                ],
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/4e6cfed053220cb785846.jpg",
        caption=f"""ᴘʀᴏɢʀᴀᴍᴍᴇʀ [𝒁𝑬𝒁𝑶_𝑲𝑨𝑹𝑴𝑶𝒁](https://t.me/ZEYADZAGLOL) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("⌯ 𓆩✘𝒁𝑬𝒁𝑶 𖤐 ™𝑲𝑨𝑹𝑴𝑶𝒁✘𓆪 ⌯", url=f"https://t.me/ZEYADZAGLOL"),
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton("♡اضف البوت الى مجموعتك♡", url=f"https://t.me/ZEYADZAGLOLABOT?startgroup=true"),
            ]
         ]
     )
  )
...
@Client.on_message(command(["لب التوكن", f"لب_التوكن", "AIex_7"]) & filters.private & ~filters.edited)
@sudo_users_only
